...
static const _Tentamen_type_support_symbol_names_t _Tentamen_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, g1_interface_pkg, msg, Tentamen)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, g1_interface_pkg, msg, Tentamen)),
  }
};
...
{
  return &::g1_interface_pkg::msg::rosidl_typesupport_cpp::Tentamen_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, g1_interface_pkg, msg, Tentamen)() {
  return get_message_type_support_handle<g1_interface_pkg::msg::Tentamen>();
}
