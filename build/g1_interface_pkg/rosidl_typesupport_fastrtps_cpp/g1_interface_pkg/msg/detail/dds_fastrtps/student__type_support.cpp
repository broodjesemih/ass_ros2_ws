...
#include "g1_interface_pkg/msg/detail/student__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = g1_interface_pkg::msg::Student;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const g1_interface_pkg::msg::Student *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<g1_interface_pkg::msg::Student *>(
    untyped_ros_message);
...
{
  return &g1_interface_pkg::msg::typesupport_fastrtps_cpp::_Student__handle;
}
