...
#include "g1_interface_pkg/msg/detail/tentamen__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const g1_interface_pkg::msg::Tentamen & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  g1_interface_pkg::msg::Tentamen & ros_message)
{
  // Member: stamp
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = g1_interface_pkg::msg::Tentamen;
    is_plain =
      (
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_g1_interface_pkg
max_serialized_size_key_Tentamen(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
{
  auto typed_message =
    static_cast<const g1_interface_pkg::msg::Tentamen *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<g1_interface_pkg::msg::Tentamen *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _Tentamen__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const g1_interface_pkg::msg::Tentamen *>(
...
static size_t _Tentamen__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_Tentamen(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _Tentamen__callbacks = {
...
static rosidl_message_type_support_t _Tentamen__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_Tentamen__callbacks,
...
{
  return &g1_interface_pkg::msg::typesupport_fastrtps_cpp::_Tentamen__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, g1_interface_pkg, msg, Tentamen)() {
  return &g1_interface_pkg::msg::typesupport_fastrtps_cpp::_Tentamen__handle;
}
