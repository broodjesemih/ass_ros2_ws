...
{
  new (message_memory) g1_interface_pkg::msg::Student(_init);
}

void Student_fini_function(void * message_memory)
{
  auto typed_message = static_cast<g1_interface_pkg::msg::Student *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Student_message_member_array[3] = {
  {
    ...
    offsetof(g1_interface_pkg::msg::Student, stamp),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(g1_interface_pkg::msg::Student, name),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(g1_interface_pkg::msg::Student, course),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Student_message_members = {
  ...
  3,  // number of fields
  sizeof(g1_interface_pkg::msg::Student),
...
get_message_type_support_handle<g1_interface_pkg::msg::Student>()
{
  return &::g1_interface_pkg::msg::rosidl_typesupport_introspection_cpp::Student_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, g1_interface_pkg, msg, Student)() {
  return &::g1_interface_pkg::msg::rosidl_typesupport_introspection_cpp::Student_message_type_support_handle;
}
